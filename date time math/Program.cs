...
namespace date_time_math
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Math.Ceiling(22.3) ".PadRight(45, '-') + ">  " + Math.Ceiling(22.3)); // 22,3'ten büyük minimum tamsayı değerini yazdırır
            Console.WriteLine("Math.Round(22.51) ".PadRight(45, '-') + ">  " + Math.Round(22.51));  // Sayıyı yuvarlar
            Console.WriteLine("Math.Floor(22.7) ".PadRight(45, '-') + ">  " + Math.Floor(22.7));   // 22,7'den küçük maksimum tamsayı değerini yazdırır
